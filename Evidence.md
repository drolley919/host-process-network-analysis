...
The `ipconfig` command was executed to document the system’s active network interfaces,
assigned IPv4 addresses, subnet masks, and default gateways at the time of analysis.
